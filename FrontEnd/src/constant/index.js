...
export const brokerageSpeedOrder = [
  { type: 1, name: "升序" },
  { type: 2, name: "降序" },
]
...
export const areaTypeList = [
  { name: '60㎡以下', minRoomSize: 60 },
  { name: '60-90㎡', minRoomSize: 60, maxRoomSize: 90 },
  { name: '90-120㎡', minRoomSize: 90, maxRoomSize: 120 },
  { name: '120-150㎡', minRoomSize: 120, maxRoomSize: 150 },
  { name: '150㎡以上', maxRoomSize: 150 },
]
//楼盘单价筛选
